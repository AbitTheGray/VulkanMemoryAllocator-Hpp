...
{
    namespace VMA_RAII_HPP_NAMESPACE
    {
        struct Pool;
        struct Allocation;
        struct StatsString;
        ...
        public:
            ...
            ) : m_allocator(allocator), m_pool(m_allocator.createPool(createInfo)) {}
        ...
        public:
            ...
            ) : m_allocator(allocator), m_allocation(m_allocator.allocateMemory(vkMemoryRequirements, createInfo, allocationInfo)) {}
        ...
        public:
            ...
            VULKAN_HPP_NODISCARD_WHEN_NO_EXCEPTIONS VULKAN_HPP_NAMESPACE::MemoryPropertyFlags getMemoryProperties() const
            {
                return m_allocator.getAllocationMemoryProperties(m_allocation);
            }

#pragma region Memory Mapping
            VULKAN_HPP_NODISCARD_WHEN_NO_EXCEPTIONS typename VULKAN_HPP_NAMESPACE::ResultValueType<void*>::type map() const
            {
...
#pragma region Buffer
            typename VULKAN_HPP_NAMESPACE::ResultValueType<void>::type bindBufferMemory(VULKAN_HPP_NAMESPACE::Buffer buffer) const
            {
            ...
            VULKAN_HPP_NODISCARD_WHEN_NO_EXCEPTIONS typename VULKAN_HPP_NAMESPACE::ResultValueType<VULKAN_HPP_NAMESPACE::VULKAN_HPP_RAII_NAMESPACE::Buffer>::type createAliasingBuffer(
            ...
            VULKAN_HPP_NODISCARD_WHEN_NO_EXCEPTIONS typename VULKAN_HPP_NAMESPACE::ResultValueType<VULKAN_HPP_NAMESPACE::VULKAN_HPP_RAII_NAMESPACE::Buffer>::type createAliasingBuffer2(
                const VULKAN_HPP_NAMESPACE::VULKAN_HPP_RAII_NAMESPACE::Device& device,
                VULKAN_HPP_NAMESPACE::DeviceSize allocationLocalOffset,
                const VULKAN_HPP_NAMESPACE::BufferCreateInfo& bufferCreateInfo
            ) const
...
#pragma region Image
            typename VULKAN_HPP_NAMESPACE::ResultValueType<void>::type bindImageMemory(VULKAN_HPP_NAMESPACE::Image image) const
            {
            ...
            VULKAN_HPP_NODISCARD_WHEN_NO_EXCEPTIONS typename VULKAN_HPP_NAMESPACE::ResultValueType<VULKAN_HPP_NAMESPACE::VULKAN_HPP_RAII_NAMESPACE::Image>::type createAliasingImage(
                const VULKAN_HPP_NAMESPACE::VULKAN_HPP_RAII_NAMESPACE::Device& device,
                const VULKAN_HPP_NAMESPACE::ImageCreateInfo& imageCreateInfo
            ) const
            {
                VULKAN_HPP_NAMESPACE::Image img = m_allocator.createAliasingImage(m_allocation, imageCreateInfo);
                return VULKAN_HPP_NAMESPACE::VULKAN_HPP_RAII_NAMESPACE::Image(device, img);
            }

            VULKAN_HPP_NODISCARD_WHEN_NO_EXCEPTIONS typename VULKAN_HPP_NAMESPACE::ResultValueType<VULKAN_HPP_NAMESPACE::Image>::type createAliasingImage2(
                const VULKAN_HPP_NAMESPACE::VULKAN_HPP_RAII_NAMESPACE::Device& device,
                VULKAN_HPP_NAMESPACE::DeviceSize allocationLocalOffset,
                const VULKAN_HPP_NAMESPACE::ImageCreateInfo& imageCreateInfo
            ) const
...
#pragma endregion
        ...
        public:
            AllocatedBuffer() : m_dispatcher(nullptr), m_device(nullptr), m_allocator(nullptr), m_buffer(nullptr), m_allocation(nullptr) {}
            ...
            AllocatedBuffer(
                ...
                VULKAN_HPP_NAMESPACE::Buffer buffer,
                VMA_HPP_NAMESPACE::Allocation allocation
            ) : m_dispatcher(device.getDispatcher()), m_device(device), m_allocator(allocator), m_buffer(buffer), m_allocation(allocation)
            {
                assert(m_dispatcher);
                assert(m_device);
            ...
            AllocatedBuffer(
                ...
                VULKAN_HPP_NAMESPACE::Optional<VMA_HPP_NAMESPACE::AllocationInfo> allocationInfo = nullptr
            ) : m_dispatcher(device.getDispatcher()), m_device(device), m_allocator(allocator), m_buffer(nullptr), m_allocation(nullptr)
            {
                auto buff = m_allocator.createBuffer(bufferCreateInfo, allocationCreateInfo, allocationInfo);
                m_buffer = buff.first;
            ...
            {
                auto buff = m_allocator.createBufferWithAlignment(bufferCreateInfo, allocationCreateInfo, minAlignment, allocationInfo);
                m_buffer = buff.first;
                m_allocation = buff.second;
...
#pragma endregion
        ...
        public:
            AllocatedImage() : m_dispatcher(nullptr), m_device(nullptr), m_allocator(nullptr), m_image(nullptr), m_allocation(nullptr) {}
            ...
            AllocatedImage(
                ...
                VULKAN_HPP_NAMESPACE::Image image,
                VMA_HPP_NAMESPACE::Allocation allocation
            ) : m_dispatcher(device.getDispatcher()), m_device(device), m_allocator(allocator), m_image(image), m_allocation(allocation)
            {
                assert(m_dispatcher);
                assert(m_device);
            ...
            AllocatedImage(
                ...
                const VMA_HPP_NAMESPACE::AllocationCreateInfo& allocationCreateInfo,
                VULKAN_HPP_NAMESPACE::Optional<VMA_HPP_NAMESPACE::AllocationInfo> allocationInfo = nullptr
            ) : m_dispatcher(device.getDispatcher()), m_device(device), m_allocator(allocator), m_image(nullptr), m_allocation(nullptr)
            {
                assert(m_dispatcher);
                assert(m_device);

                {
                    ...
                    auto buff = m_allocator.createImage(imageCreateInfo, allocationCreateInfo, allocationInfo);
                    m_image = buff.first;
                    m_allocation = buff.second;
...
#pragma region Image
        public:
            ...
            {
                return m_device.getImageDrmFormatModifierPropertiesEXT(m_image, *m_dispatcher);
            }
            ...
            VULKAN_HPP_NODISCARD VULKAN_HPP_NAMESPACE::StructureChain<X, Y, Z...> getSubresourceLayout2EXT( const VULKAN_HPP_NAMESPACE::ImageSubresource2KHR & subresource ) const VULKAN_HPP_NOEXCEPT
            {
            ...
            VULKAN_HPP_NODISCARD VULKAN_HPP_NAMESPACE::SubresourceLayout2KHR getSubresourceLayout2KHR( const VULKAN_HPP_NAMESPACE::ImageSubresource2KHR & subresource ) const VULKAN_HPP_NOEXCEPT
            {
                return m_device.getImageSubresourceLayout2KHR(m_image, subresource, *m_dispatcher);
            }

            template <typename X, typename Y, typename... Z>
            VULKAN_HPP_NODISCARD VULKAN_HPP_NAMESPACE::StructureChain<X, Y, Z...> getSubresourceLayout2KHR( const VULKAN_HPP_NAMESPACE::ImageSubresource2KHR & subresource ) const VULKAN_HPP_NOEXCEPT
            {
...
#pragma endregion
        ...
        public:
            ...
            ) : m_allocator(allocator), m_context(allocator.beginDefragmentation(info)) {}
        ...
        public:
            VULKAN_HPP_NODISCARD_WHEN_NO_EXCEPTIONS typename VULKAN_HPP_NAMESPACE::ResultValueType<VMA_HPP_NAMESPACE::DefragmentationPassMoveInfo>::type beginPass() const
            {
                return m_allocator.beginDefragmentationPass(m_context);
            }
            VULKAN_HPP_NODISCARD_WHEN_NO_EXCEPTIONS typename VULKAN_HPP_NAMESPACE::ResultValueType<VMA_HPP_NAMESPACE::DefragmentationPassMoveInfo>::type endPass() const
            {
        ...
        public:
            ...
            VULKAN_HPP_TYPESAFE_EXPLICIT Allocator(VMA_HPP_NAMESPACE::Allocator allocator) VULKAN_HPP_NOEXCEPT : m_allocator(allocator) {}
            VULKAN_HPP_TYPESAFE_EXPLICIT Allocator(const AllocatorCreateInfo& createInfo) : m_allocator(createAllocator(createInfo)) {}
            ...
            template<typename VectorAllocator = std::allocator<VMA_HPP_NAMESPACE::Budget>,
                ...
                typename std::enable_if<std::is_same<typename B::value_type, VMA_HPP_NAMESPACE::Budget>::value, int>::type = 0>
            VULKAN_HPP_NODISCARD_WHEN_NO_EXCEPTIONS std::vector<VMA_HPP_NAMESPACE::Budget, VectorAllocator> getHeapBudgets(VectorAllocator& vectorAllocator) const
            {
                return m_allocator.getHeapBudgets(vectorAllocator);
            }

            template<typename VectorAllocator = std::allocator<VMA_HPP_NAMESPACE::Budget>>
            VULKAN_HPP_NODISCARD_WHEN_NO_EXCEPTIONS std::vector<VMA_HPP_NAMESPACE::Budget, VectorAllocator> getHeapBudgets() const
            {
                return m_allocator.getHeapBudgets();
            }

            VULKAN_HPP_NODISCARD_WHEN_NO_EXCEPTIONS typename VULKAN_HPP_NAMESPACE::ResultValueType<uint32_t>::type findMemoryTypeIndex(
            ...
            VULKAN_HPP_NODISCARD_WHEN_NO_EXCEPTIONS typename VULKAN_HPP_NAMESPACE::ResultValueType<uint32_t>::type findMemoryTypeIndexForBufferInfo(
                const VULKAN_HPP_NAMESPACE::BufferCreateInfo& bufferCreateInfo,
                const VMA_HPP_NAMESPACE::AllocationCreateInfo& allocationCreateInfo
            ) const
            {
            ...
            VULKAN_HPP_NODISCARD_WHEN_NO_EXCEPTIONS typename VULKAN_HPP_NAMESPACE::ResultValueType<uint32_t>::type findMemoryTypeIndexForImageInfo(
                const VULKAN_HPP_NAMESPACE::ImageCreateInfo& imageCreateInfo,
                const VMA_HPP_NAMESPACE::AllocationCreateInfo& allocationCreateInfo
            ) const
            {
            ...
            VULKAN_HPP_NODISCARD_WHEN_NO_EXCEPTIONS typename VULKAN_HPP_NAMESPACE::ResultValueType<Pool>::type createPool(const VMA_HPP_NAMESPACE::PoolCreateInfo& createInfo) const
            {
                return Pool(this->operator VmaAllocator(), createInfo);
            }

            VULKAN_HPP_NODISCARD_WHEN_NO_EXCEPTIONS typename VULKAN_HPP_NAMESPACE::ResultValueType<Allocation>::type allocateMemory(
                const VULKAN_HPP_NAMESPACE::MemoryRequirements& vkMemoryRequirements,
                const VMA_HPP_NAMESPACE::AllocationCreateInfo& createInfo,
                VULKAN_HPP_NAMESPACE::Optional<VMA_HPP_NAMESPACE::AllocationInfo> allocationInfo = nullptr
            ) const
...
#pragma region Allocations
            ...
            VULKAN_HPP_NODISCARD_WHEN_NO_EXCEPTIONS typename VULKAN_HPP_NAMESPACE::ResultValueType<std::vector<Allocation, VectorAllocator>>::type allocateMemoryPages(
            ...
            VULKAN_HPP_NODISCARD_WHEN_NO_EXCEPTIONS typename VULKAN_HPP_NAMESPACE::ResultValueType<std::vector<Allocation, VectorAllocator>>::type allocateMemoryPages(
                VULKAN_HPP_NAMESPACE::ArrayProxy<const VULKAN_HPP_NAMESPACE::MemoryRequirements> vkMemoryRequirements,
                VULKAN_HPP_NAMESPACE::ArrayProxy<const VMA_HPP_NAMESPACE::AllocationCreateInfo> createInfo,
                VULKAN_HPP_NAMESPACE::ArrayProxyNoTemporaries<VMA_HPP_NAMESPACE::AllocationInfo> allocationInfo = nullptr
            ) const; //TODO

            VULKAN_HPP_NODISCARD_WHEN_NO_EXCEPTIONS typename VULKAN_HPP_NAMESPACE::ResultValueType<Allocation>::type allocateMemoryForBuffer(
                VULKAN_HPP_NAMESPACE::Buffer buffer,
                const VMA_HPP_NAMESPACE::AllocationCreateInfo& createInfo,
                VULKAN_HPP_NAMESPACE::Optional<VMA_HPP_NAMESPACE::AllocationInfo> allocationInfo = nullptr
            ) const; //TODO

            VULKAN_HPP_NODISCARD_WHEN_NO_EXCEPTIONS typename VULKAN_HPP_NAMESPACE::ResultValueType<Allocation>::type allocateMemoryForImage(
                VULKAN_HPP_NAMESPACE::Image image,
                const VMA_HPP_NAMESPACE::AllocationCreateInfo& createInfo,
                VULKAN_HPP_NAMESPACE::Optional<VMA_HPP_NAMESPACE::AllocationInfo> allocationInfo = nullptr
            ) const; //TODO
...
#pragma endregion
            ...
            typename VULKAN_HPP_NAMESPACE::ResultValueType<void>::type checkCorruption(uint32_t memoryTypeBits) const { return m_allocator.checkCorruption(memoryTypeBits); }

#pragma region Stats String
            VULKAN_HPP_NODISCARD_WHEN_NO_EXCEPTIONS StatsString buildStatsString(VULKAN_HPP_NAMESPACE::Bool32 detailedMap) const
            {
